                                ...
                                <tr class="hover:bg-gray-50 transition-colors group">
                                    ...
                                    <td class="px-8 py-6">
                                        ...
                                        <?php if($paymentStatus === 'paid' && isset($receiptPaymentIds[$booking->id])): ?>
                                            <a href="<?php echo e(route('payments.receipt', $receiptPaymentIds[$booking->id])); ?>" class="px-3 py-2 bg-orange-50 text-[#ff5a1f] rounded-lg text-xs font-black hover:bg-orange-100 transition-colors inline-flex">View Receipt</a>
                                        <?php else: ?>
                                    ...
                                    <td class="px-8 py-6 text-right">
                                        <div class="flex items-center justify-end gap-3">
                                            ...
                                            <a href="<?php echo e(route('bookings.show', $booking->id)); ?>" class="px-4 py-2 bg-blue-50 text-blue-600 rounded-lg text-xs font-black hover:bg-blue-100 transition-colors">
                                              View Details
                                            </a>
                                            ...
                                            <?php if($booking->status === 'Pending'): ?>
                                                <details class="text-left">
                                                    ...
                                                    <form action="<?php echo e(route('bookings.reschedule', $booking->id)); ?>" method="POST" class="mt-3 bg-gray-50 p-3 rounded-xl border border-gray-100 space-y-2">
                                                        <?php echo csrf_field(); ?>
                                                        <input type="date" name="preferred_date" value="<?php echo e($booking->preferred_date); ?>" class="w-full px-3 py-2 bg-white border border-gray-200 rounded-lg text-xs font-bold">
                                            ...
                                            <?php if($booking->status === 'Completed'): ?>
                                                <a href="<?php echo e(route('bookings.invoice', $booking->id)); ?>" class="px-3 py-2 bg-green-50 text-green-600 rounded-lg text-xs font-black hover:bg-green-100">Invoice</a>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                </tr>
