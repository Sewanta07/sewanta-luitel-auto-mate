...
<div id="vehicle-modal-backdrop" class="cs-vehicle-modal-backdrop fixed inset-0 bg-black/50 z-[60] items-start sm:items-center justify-center p-4 sm:p-6 overflow-y-auto" style="display: none;">
    <div id="vehicle-modal" class="cs-vehicle-modal bg-white rounded-3xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto transform scale-95 opacity-0 transition-all duration-300 my-4 sm:my-0">
        <div class="cs-vehicle-modal-body p-5 sm:p-8">
            ...
            <form action="<?php echo e(route('vehicles.store')); ?>" method="POST" class="cs-vehicle-form space-y-6" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="cs-vehicle-form-grid grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="cs-vehicle-field-group">
                        ...
                        <input type="number" name="year" placeholder="2018" required min="1900" max="<?php echo e(date('Y')); ?>" class="cs-vehicle-field-control block w-full px-4 py-3 rounded-xl border-gray-200 focus:border-[#ff5a1f] focus:ring-[#ff5a1f] transition duration-200">
                    </div>
                    <div class="cs-vehicle-field-group cs-vehicle-field-group-full sm:col-span-2">
...
<?php echo $__env->make('layouts.customer-core', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AutoMate\resources\views\customer\vehicles\index.blade.php ENDPATH**/ ?>