<?php $__env->startSection('title', 'Rent Vehicles - AutoMate'); ?>
            ...
            <div class="cs-rent-alert cs-rent-alert-error mb-6 p-4 rounded-2xl bg-red-50 border border-red-100 text-red-800 animate-fade-in">
                ...
                <ul class="cs-rent-alert-list list-disc pl-5 space-y-1 text-sm">
                    <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="cs-rent-alert-item"><?php echo e($error); ?></li>
                    ...
                    <div class="cs-rent-card bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition duration-300 flex flex-col group">
                        ...
                        <div class="cs-rent-card-media relative h-48 bg-gray-100 overflow-hidden">
                            ...
                            <?php if(count($allImages) > 0): ?>
                                <img src="<?php echo e(asset('storage/' . $allImages[0])); ?>"
                                     class="cs-rent-card-image w-full h-full object-cover"
                                     alt="<?php echo e($vehicle->vehicle_name ?? $vehicle->brand); ?>">
                            <?php else: ?>
                        ...
                        <div class="cs-rent-card-body p-6 flex-1">
                            ...
                            <p class="cs-rent-card-details text-sm text-gray-500 mb-2"><?php echo e($vehicle->vehicle_type ?? 'Vehicle'); ?> • <?php echo e($vehicle->fuel_type ?? 'Fuel N/A'); ?> • <?php echo e($vehicle->transmission_type ?? 'Transmission N/A'); ?></p>
                            <p class="cs-rent-card-owner text-xs text-gray-400 mb-3">
                                <span class="cs-rent-card-owner-inline inline-flex items-center">
                                    ...
                                    Owner: <?php echo e($isAdminVehicle ? 'AutoMate Service Center' : ($vehicle->customer->name ?? 'N/A')); ?>
                            ...
                            <div class="cs-rent-card-rate flex items-center text-lg font-bold text-[#ff5a1f] mb-3">
                                ...
                                Rs. <?php echo e($displayRate !== null ? number_format($displayRate, 2) : 'N/A'); ?> / day
                            </div>
                        ...
                        <div class="cs-rent-card-actions px-6 py-4 bg-gray-50/50 border-t border-gray-50">
                            <button
                                ...
                                data-vehicle-id="<?php echo e($vehiclePayload['id']); ?>"
                                data-owner-vehicle-id="<?php echo e($vehiclePayload['owner_vehicle_id']); ?>"
                                data-rental-type="<?php echo e($vehiclePayload['rental_type']); ?>"
                                data-vehicle-name="<?php echo e($vehiclePayload['name']); ?>"
                                data-vehicle-details="<?php echo e($vehiclePayload['details']); ?>"
                                data-vehicle-owner="<?php echo e($vehiclePayload['owner']); ?>"
                                data-vehicle-rate="<?php echo e($vehiclePayload['rate']); ?>"
                                data-vehicle-image="<?php echo e($vehiclePayload['image'] ?? ''); ?>"
            ...
            <div id="rent-modal-backdrop" class="cs-rent-modal-backdrop fixed inset-0 z-[90] bg-black/50 backdrop-blur-sm px-4 sm:px-6 pt-20 sm:pt-24 pb-6 hidden items-start justify-center overflow-y-auto">
                <div id="rent-modal" class="cs-rent-modal bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[calc(100vh-7rem)] sm:max-h-[calc(100vh-8rem)] overflow-y-auto">
                    <div class="cs-rent-modal-body p-5 sm:p-8">
                        ...
                        <form id="rent-request-form" action="<?php echo e(route('rent-vehicles.request')); ?>" method="POST" class="cs-rent-form space-y-4">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="cs-rent-form-grid grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="cs-rent-field-group">
                                    ...
                                    <input type="date" id="rent-start-date" name="start_date" required class="cs-rent-field-control w-full px-4 py-3 rounded-xl border border-gray-200 text-sm focus:border-[#ff5a1f] focus:ring-[#ff5a1f]" min="<?php echo e(date('Y-m-d')); ?>">
                                </div>
                                <div class="cs-rent-field-group">
                                    <label class="cs-rent-field-label block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">End Date</label>
                                    <input type="date" id="rent-end-date" name="end_date" required class="cs-rent-field-control w-full px-4 py-3 rounded-xl border border-gray-200 text-sm focus:border-[#ff5a1f] focus:ring-[#ff5a1f]" min="<?php echo e(date('Y-m-d')); ?>">
                                </div>
                            </div>
                            ...
                            <div class="cs-rent-form-grid grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="cs-rent-field-group">
                                    ...
                                    <input type="tel" name="renter_contact" value="<?php echo e(old('renter_contact')); ?>" placeholder="Your contact number" class="cs-rent-field-control w-full px-4 py-3 rounded-xl border border-gray-200 text-sm focus:border-[#ff5a1f] focus:ring-[#ff5a1f]">
                                </div>
                                <div class="cs-rent-field-group">
                                    ...
                                    <input type="text" name="pickup_location" value="<?php echo e(old('pickup_location')); ?>" placeholder="Where to pickup" class="cs-rent-field-control w-full px-4 py-3 rounded-xl border border-gray-200 text-sm focus:border-[#ff5a1f] focus:ring-[#ff5a1f]">
                                </div>
                            </div>
                            ...
                            <div class="cs-rent-field-group">
                                ...
                                <textarea name="notes" rows="3" class="cs-rent-field-control cs-rent-field-textarea w-full px-4 py-3 rounded-xl border border-gray-200 text-sm focus:border-[#ff5a1f] focus:ring-[#ff5a1f]" placeholder="Any extra request details..."><?php echo e(old('notes')); ?></textarea>
                            </div>
                            ...
                            <div class="cs-rent-field-group">
                                ...
                                <input type="text" name="service_link" value="<?php echo e(old('service_link')); ?>" placeholder="Paste booking link if applicable" class="cs-rent-field-control w-full px-4 py-3 rounded-xl border border-gray-200 text-sm focus:border-[#ff5a1f] focus:ring-[#ff5a1f]">
                            </div>
...
<script>
    function openRentModalFromButton(button) {
        ...
        formEl.action = '<?php echo e(route('rent-vehicles.request')); ?>';
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const startDateEl = document.getElementById('rent-start-date');
        const endDateEl = document.getElementById('rent-end-date');
        const today = '<?php echo e(date('Y-m-d')); ?>';
...
<?php echo $__env->make('layouts.customer-core', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AutoMate\resources\views\customer\rent-vehicles.blade.php ENDPATH**/ ?>