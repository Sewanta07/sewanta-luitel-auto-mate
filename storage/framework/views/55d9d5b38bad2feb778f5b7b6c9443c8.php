                    ...
                    <div class="divide-y max-h-96 overflow-y-auto">
                        <?php $__empty_1 = true; $__currentLoopData = $staffMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <a href="<?php echo e(route('customer.messages.show', $staff->id)); ?>" 
                               class="block p-4 hover:bg-orange-50 transition-colors border-l-4 <?php echo e(isset($selectedStaff) && $selectedStaff->id === $staff->id ? 'border-[#ff5a1f] bg-orange-50' : 'border-transparent'); ?>">
                               ...
                               <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <p class="font-bold text-gray-900 truncate"><?php echo e($staff->name); ?></p>
                                        <p class="text-xs text-gray-500"><?php echo e($staff->specialization ?? 'Staff Member'); ?></p>
                                    </div>
                                </div>
                            </a>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col h-full" style="max-height: 600px;">
                        ...
                        <div class="p-6 bg-gradient-to-r from-[#ff5a1f] to-orange-500 text-white border-b">
                            <div class="flex items-center gap-3">
                                ...
                                <?php endif; ?>
                                <div>
                                    <h3 class="font-bold text-lg"><?php echo e($selectedStaff->name); ?></h3>
                                    <p class="text-orange-100 text-sm"><?php echo e($selectedStaff->specialization ?? 'Staff Member'); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex-1 p-6 overflow-y-auto bg-gray-50" id="messagesContainer">
                            <?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="mb-4 flex <?php echo e($message->isSentByCustomer() ? 'justify-end' : 'justify-start'); ?>" data-message-id="<?php echo e((int) $message->id); ?>">
                                    <div class="max-w-xs lg:max-w-md">
                                        <p class="text-[10px] font-black uppercase tracking-widest mb-1 <?php echo e($message->isSentByCustomer() ? 'text-orange-400 text-right' : 'text-gray-400'); ?>">
                                            <?php echo e($message->isSentByCustomer() ? ($customer->name ?? 'You') : ($selectedStaff->name ?? 'Staff')); ?>

                                        </p>
                                        <div class="px-4 py-3 rounded-2xl <?php echo e($message->isSentByCustomer() ? 'bg-[#ff5a1f] text-white rounded-br-none' : 'bg-gray-200 text-gray-900 rounded-bl-none'); ?>">
                                            <p class="break-words"><?php echo e($message->message ?? $message->content); ?></p>
                                            <p class="text-xs mt-2 <?php echo e($message->isSentByCustomer() ? 'text-orange-100' : 'text-gray-600'); ?>">
                        ...
                        <div class="p-6 border-t bg-white">
                            <form action="<?php echo e(route('customer.messages.send', $selectedStaff->id)); ?>" method="POST" class="flex gap-3">
                                <?php echo csrf_field(); ?>
                                <div class="flex-1">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const currentUserId = <?php echo json_encode((int) $customer->id, 15, 512) ?>;
        const currentUserType = <?php echo json_encode(get_class($customer), 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AutoMate\resources\views/customer/messages.blade.php ENDPATH**/ ?>