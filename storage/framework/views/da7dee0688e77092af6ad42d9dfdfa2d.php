...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="custom_service" id="custom_service" value="<?php echo e(old('custom_service')); ?>" 
                           class="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-bold placeholder-gray-500 focus:ring-4 focus:ring-orange-100 focus:bg-white transition-all <?php $__errorArgs = ['custom_service'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
