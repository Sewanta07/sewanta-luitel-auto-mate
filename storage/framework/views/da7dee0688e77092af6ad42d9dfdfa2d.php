...
<div class="cs-page cs-booking-create-page min-h-screen bg-gray-50 pb-20">
    <div class="cs-container cs-booking-create-container max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <a href="<?php echo e(route('bookings.index')); ?>" class="cs-back-link inline-flex items-center text-sm font-bold text-gray-400 hover:text-[#ff5a1f] transition-colors mb-6 group">
        ...
        <div class="cs-surface cs-form-card bg-white rounded-3xl shadow-xl p-6 sm:p-10 border border-gray-100">
            <form action="<?php echo e(route('bookings.store')); ?>" method="POST" class="cs-form-stack space-y-8">
                <?php echo csrf_field(); ?>
                ...
                <?php if($preFilledVehicle): ?>
                    <div class="cs-note cs-note-info cs-prefill-note p-4 rounded-2xl bg-blue-50 border border-blue-100 flex items-start">
                        ...
                        <div class="cs-prefill-note-content">
                            ...
                            <p class="cs-prefill-note-text text-xs text-blue-700 mt-1">The information for <strong><?php echo e($preFilledVehicle->brand); ?> <?php echo e($preFilledVehicle->model); ?></strong> (<?php echo e($preFilledVehicle->plate_number); ?>) has been automatically filled in the form below.</p>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="cs-form-grid cs-form-grid-vehicle grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="cs-field-group cs-field-group-full md:col-span-2">
                        ...
                        <input type="text" name="vehicle_model" id="vehicle_model" list="nepal-vehicles" value="<?php echo e($preFilledVehicle ? $preFilledVehicle->model : old('vehicle_model')); ?>" 
                               class="cs-field-control w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-bold focus:ring-4 focus:ring-orange-100 focus:bg-white transition-all <?php $__errorArgs = ['vehicle_model'];
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <p class="cs-field-error mt-2 text-xs font-bold text-red-500 ml-1"><?php echo e($message); ?></p>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                ...
                <div class="cs-form-grid cs-form-grid-basics grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="cs-field-group">
                        ...
                        <input type="number" name="vehicle_year" id="vehicle_year" value="<?php echo e($preFilledVehicle ? $preFilledVehicle->year : old('vehicle_year')); ?>" min="1980" max="<?php echo e(now()->year); ?>"
                               class="cs-field-control w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-bold focus:ring-4 focus:ring-orange-100 focus:bg-white transition-all <?php $__errorArgs = ['vehicle_year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="cs-field-group">
                        ...
                        <input type="text" name="vehicle_number" id="vehicle_number" value="<?php echo e($preFilledVehicle ? $preFilledVehicle->plate_number : old('vehicle_number')); ?>" 
                               class="cs-field-control w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-bold focus:ring-4 focus:ring-orange-100 focus:bg-white transition-all <?php $__errorArgs = ['vehicle_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
                ...
                <div class="cs-form-grid cs-form-grid-service grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="cs-field-group">
                        ...
                        <select name="vehicle_type" id="vehicle_type" 
                                class="cs-field-control w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-bold focus:ring-4 focus:ring-orange-100 focus:bg-white transition-all appearance-none <?php $__errorArgs = ['vehicle_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="cs-field-group">
                        ...
                        <select name="service_type" id="service_type" 
                                class="cs-field-control w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-bold focus:ring-4 focus:ring-orange-100 focus:bg-white transition-all appearance-none <?php $__errorArgs = ['service_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
                ...
                <div class="cs-form-grid cs-form-grid-schedule grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="cs-field-group">
                        ...
                        <input type="date" name="preferred_date" id="preferred_date" value="<?php echo e(old('preferred_date', date('Y-m-d'))); ?>" 
                               class="cs-field-control w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-bold text-gray-900 focus:ring-4 focus:ring-orange-100 focus:bg-white transition-all <?php $__errorArgs = ['preferred_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="cs-field-group">
                        ...
                        <select name="preferred_time_slot" id="preferred_time_slot" 
                                class="cs-field-control w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-bold text-gray-900 focus:ring-4 focus:ring-orange-100 focus:bg-white transition-all appearance-none <?php $__errorArgs = ['preferred_time_slot'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
                ...
                <div class="cs-form-grid cs-form-grid-priority grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="cs-field-group">
                        ...
                        <select name="service_priority" id="service_priority" 
                                class="cs-field-control w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-bold focus:ring-4 focus:ring-orange-100 focus:bg-white transition-all appearance-none <?php $__errorArgs = ['service_priority'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="cs-field-group">
                        ...
                        <select name="service_location_type" id="service_location_type" 
                                class="cs-field-control w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-bold focus:ring-4 focus:ring-orange-100 focus:bg-white transition-all appearance-none <?php $__errorArgs = ['service_location_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
                ...
                <div class="cs-form-grid cs-form-grid-contact grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="cs-field-group">
                        ...
                        <input type="text" name="location" id="location" value="<?php echo e(old('location')); ?>" 
                               class="cs-field-control w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-bold focus:ring-4 focus:ring-orange-100 focus:bg-white transition-all <?php $__errorArgs = ['location'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="cs-field-group">
                        ...
                        <input type="text" name="phone_number" id="phone_number" value="<?php echo e(old('phone_number', auth()->user()->phone ?? '')); ?>" 
                               class="cs-field-control w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-bold focus:ring-4 focus:ring-orange-100 focus:bg-white transition-all <?php $__errorArgs = ['phone_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
                ...
                <div class="cs-form-grid cs-form-grid-notes grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="cs-field-group">
                        ...
                        <textarea name="problem_description" id="problem_description" rows="4" 
                                  class="cs-field-control cs-field-textarea w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-medium placeholder-gray-500 focus:ring-4 focus:ring-orange-100 focus:bg-white transition-all resize-none <?php $__errorArgs = ['problem_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="cs-field-group">
                        ...
                        <select name="pickup_drop" id="pickup_drop" 
                                class="cs-field-control w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-bold focus:ring-4 focus:ring-orange-100 focus:bg-white transition-all appearance-none <?php $__errorArgs = ['pickup_drop'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
...
<?php echo $__env->make('layouts.customer-core', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AutoMate\resources\views/customer/bookings/create.blade.php ENDPATH**/ ?>