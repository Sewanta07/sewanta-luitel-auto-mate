<div class="p-10 rounded-2xl bg-white shadow-sm text-center">
  ...
  <div class="mt-6">
    <a href="#" class="inline-flex items-center px-4 py-2 text-white rounded-lg shadow transition" style="background-color: #ff5a1f;" onmouseover="this.style.backgroundColor='#e64b15'" onmouseout="this.style.backgroundColor='#ff5a1f'">Request Service</a>
  </div>
</div>
<?php /**PATH C:\xampp\htdocs\AutoMate\resources\views\customer\components\empty-state.blade.php ENDPATH**/ ?>