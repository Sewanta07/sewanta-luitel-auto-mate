...
<?php $__env->startSection('title', 'My Service Requests - AutoMate'); ?>
    ...
    <main class="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 mb-6">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <a href="<?php echo e(route('customer.requests.create')); ?>" class="inline-flex items-center justify-center px-5 py-2.5 rounded-xl bg-[#ff5a1f] text-white font-semibold text-sm hover:bg-[#e64b15] shadow-lg shadow-orange-100 transition duration-200">
        ...
        <div id="empty-state" class="hidden flex flex-col items-center justify-center py-24 px-4 bg-white rounded-2xl shadow-sm border border-gray-100 text-center">
            ...
            <a href="<?php echo e(route('customer.requests.create')); ?>" class="px-8 py-3 rounded-xl bg-[#ff5a1f] text-white font-bold shadow-lg shadow-orange-100 hover:bg-[#e64b15] transition transform hover:-translate-y-0.5">
                Request a Service
            </a>
        </div>
    </main>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AutoMate\resources\views/customer/requests/index.blade.php ENDPATH**/ ?>