                                ...
                                <tr class="hover:bg-gray-50 transition-colors group">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="w-20 bg-gray-200 rounded-full h-2.5">
                                                <div class="bg-gradient-to-r <?php echo e($item->stock_status === 'out_of_stock' ? 'from-red-500 to-red-600' : ($item->stock_status === 'low_stock' ? 'from-orange-500 to-orange-600' : 'from-green-500 to-green-600')); ?> h-2.5 rounded-full <?php echo e($stockWidthClass); ?>"></div>
                                            </div>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            <form action="<?php echo e(route('admin.inventory.destroy', $item->id)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this item? This action cannot be undone.');">
                                                <?php echo csrf_field(); ?>
