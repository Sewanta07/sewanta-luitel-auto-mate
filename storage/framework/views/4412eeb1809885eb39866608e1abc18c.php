        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-6">
                        ...
                        <div class="inline-block relative">
                            <div class="w-16 h-16 rounded-full border-4 border-white shadow-lg overflow-hidden mx-auto mb-4 bg-gray-100 flex items-center justify-center">
                                <?php if($admin->profile_image): ?>
                                    <img src="<?php echo e(asset('storage/' . $admin->profile_image)); ?>" alt="Profile" class="w-full h-full object-cover">
                                <?php else: ?>
                                    <span class="text-2xl font-bold text-[#ff5a1f]"><?php echo e(strtoupper(substr($admin->name, 0, 1))); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                        <h2 class="text-xl font-bold text-gray-900"><?php echo e($admin->name); ?></h2>
                        <p class="text-sm text-gray-500 mb-2"><?php echo e($admin->email); ?></p>
                    ...
                    <div class="border-t border-gray-100 p-6 bg-gray-50">
                        ...
                        <div class="space-y-3 text-sm">
                            <div class="flex justify-between">
                                ...
                                <span class="font-mono font-medium text-gray-900">#<?php echo e($admin->id); ?></span>
                            </div>
                            <div class="flex justify-between">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="text-gray-900 font-medium"><?php echo e($admin->created_at->format('M d, Y')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
                    ...
                    <form action="<?php echo e(route('admin.profile.password')); ?>" method="POST" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <div>
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
                    ...
                    <form action="<?php echo e(route('admin.profile.update')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                                <div class="w-12 h-12 rounded-full overflow-hidden border-4 border-orange-100 bg-gray-100 flex items-center justify-center flex-shrink-0">
                                    <?php if($admin->profile_image): ?>
                                        <img src="<?php echo e(asset('storage/' . $admin->profile_image)); ?>" alt="Profile" class="w-12 h-12 object-cover rounded-full" id="profile-preview">
                                    <?php else: ?>
                                        <span class="text-xl font-bold text-gray-300"><?php echo e(strtoupper(substr($admin->name, 0, 1))); ?></span>
                                    <?php endif; ?>
                                </div>
                                <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name', $admin->name)); ?>" required class="block w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#ff5a1f] focus:ring-2 focus:ring-[#ff5a1f] focus:ring-opacity-10 transition duration-200">
                        </div>

                        
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Email Address</label>
                            <input type="email" name="email" value="<?php echo e(old('email', $admin->email)); ?>" required class="block w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#ff5a1f] focus:ring-2 focus:ring-[#ff5a1f] focus:ring-opacity-10 transition duration-200">
                        </div>

                        
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Phone Number</label>
                            <input type="tel" name="phone" value="<?php echo e(old('phone', $admin->phone)); ?>" class="block w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#ff5a1f] focus:ring-2 focus:ring-[#ff5a1f] focus:ring-opacity-10 transition duration-200">
                        </div>

                        
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Address</label>
                            <textarea name="current_address" rows="3" class="block w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#ff5a1f] focus:ring-2 focus:ring-[#ff5a1f] focus:ring-opacity-10 transition duration-200"><?php echo e(old('current_address', $admin->current_address)); ?></textarea>
                        </div>
