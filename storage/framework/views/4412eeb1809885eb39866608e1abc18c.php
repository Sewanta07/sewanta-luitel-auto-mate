                    ...
                    <div class="p-6 text-center">
                        <div class="inline-block relative">
                            <div class="w-12 h-12 rounded-full border-4 border-white shadow-lg overflow-hidden mx-auto mb-4 bg-gray-100 flex items-center justify-center">
                                ...
                                <?php else: ?>
                                    <span class="text-xl font-bold text-[#ff5a1f]"><?php echo e(strtoupper(substr($admin->name, 0, 1))); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                                <div class="w-10 h-10 rounded-full overflow-hidden border-4 border-orange-100 bg-gray-100 flex items-center justify-center flex-shrink-0">
                                    <?php if($admin->profile_image): ?>
                                        <img src="<?php echo e(asset('storage/' . $admin->profile_image)); ?>" alt="Profile" class="w-10 h-10 object-cover rounded-full" id="profile-preview">
                                    <?php else: ?>
                                        <span class="text-lg font-bold text-gray-300"><?php echo e(strtoupper(substr($admin->name, 0, 1))); ?></span>
                                    <?php endif; ?>
                                </div>
                                <div>
