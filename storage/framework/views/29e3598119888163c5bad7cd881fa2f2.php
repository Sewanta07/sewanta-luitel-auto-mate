        ...
        <div class="lp-container">
            <div class="lp-nav-row">
                <div class="lp-brand-wrap">
                    <img src="<?php echo e(asset('assets/branding/company-logo.png')); ?>" alt="AutoMate" class="lp-logo-image">
                </div>
                ...
                <div class="lp-nav-links">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('dashboard.' . auth()->user()->role)); ?>" class="lp-btn lp-btn-primary lp-btn-sm">
                            Dashboard
                        </a>
                    <?php else: ?>
                        <div class="lp-nav-auth">
                            <a href="<?php echo e(route('login')); ?>" class="lp-login-link">Log in</a>
                            <a href="<?php echo e(route('register')); ?>" class="lp-btn lp-btn-primary lp-btn-sm">
                                Get Started
                            </a>
                        </div>
                    <?php endif; ?>
                ...
                <div class="lp-mobile-toggle-wrap">
                    <button class="lp-mobile-toggle" type="button" aria-label="Open menu">
                        <img src="<?php echo e(asset('assets/landing/icons/menu.svg')); ?>" alt="Menu" class="lp-icon-lg lp-icon-img">
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="lp-container lp-hero-row">
            ...
            <div class="lp-hero-copy">
                ...
                <div class="lp-hero-actions">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('dashboard.' . auth()->user()->role)); ?>" class="lp-btn lp-btn-primary lp-btn-lg">
                            Go to Dashboard
                            <img src="<?php echo e(asset('assets/landing/icons/arrow-right-white.svg')); ?>" alt="Arrow" class="lp-icon-sm lp-icon-right lp-icon-img">
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('register')); ?>" class="lp-btn lp-btn-primary lp-btn-lg">
                            Book a Service
                            <img src="<?php echo e(asset('assets/landing/icons/arrow-right-white.svg')); ?>" alt="Arrow" class="lp-icon-sm lp-icon-right lp-icon-img">
                        </a>
                        <a href="<?php echo e(route('login')); ?>" class="lp-btn lp-btn-outline lp-btn-lg">
                            Log In
                        </a>
                    <?php endif; ?>
                </div>
            ...
            <div class="lp-hero-media">
                ...
                <img src="<?php echo e(asset('assets/landing/icons/hero-shape.svg')); ?>" alt="" class="lp-hero-bg" aria-hidden="true">
                
                <div class="lp-hero-image-wrap">
                    <img src="<?php echo e(asset('assets/landing/images/hero-car.jpg')); ?>" alt="Car Service" class="lp-hero-image">
            ...
            <div class="lp-hiw-grid">
                <div class="lp-hiw-item">
                    <div class="lp-hiw-icon lp-hiw-icon-blue">
                        <img src="<?php echo e(asset('assets/landing/icons/home-blue.svg')); ?>" alt="Select service" class="lp-icon-xl lp-icon-img">
                    </div>
                ...
                <div class="lp-hiw-item">
                    <div class="lp-hiw-icon lp-hiw-icon-orange">
                        <img src="<?php echo e(asset('assets/landing/icons/calendar-orange.svg')); ?>" alt="Book slot" class="lp-icon-xl lp-icon-img">
                    </div>
                ...
                <div class="lp-hiw-item">
                    <div class="lp-hiw-icon lp-hiw-icon-purple">
                        <img src="<?php echo e(asset('assets/landing/icons/clipboard-purple.svg')); ?>" alt="Track progress" class="lp-icon-xl lp-icon-img">
                    </div>
                ...
                <div class="lp-hiw-item">
                    <div class="lp-hiw-icon lp-hiw-icon-green">
                        <img src="<?php echo e(asset('assets/landing/icons/check-green.svg')); ?>" alt="Drive away" class="lp-icon-xl lp-icon-img">
                    </div>
    ...
    <section id="services" class="lp-section lp-section-gray">
        <div class="lp-container">
            <div class="lp-services-head">
                ...
                <a href="<?php echo e(route('register')); ?>" class="lp-view-all-link">
                    View All Services <img src="<?php echo e(asset('assets/landing/icons/arrow-right-accent.svg')); ?>" alt="Arrow" class="lp-icon-sm lp-icon-right lp-icon-img">
                </a>
            </div>
            ...
            <div class="lp-services-grid">
                ...
                <div class="lp-service-card lp-service-card-orange">
                    <div class="lp-service-icon-wrap">
                        <img src="<?php echo e(asset('assets/landing/icons/settings-orange.svg')); ?>" alt="General maintenance" class="lp-icon-lg lp-icon-img">
                    </div>
                ...
                <div class="lp-service-card lp-service-card-blue">
                    <div class="lp-service-icon-wrap">
                        <img src="<?php echo e(asset('assets/landing/icons/wrench-blue.svg')); ?>" alt="Engine and transmission" class="lp-icon-lg lp-icon-img">
                    </div>
                ...
                <div class="lp-service-card lp-service-card-purple">
                    <div class="lp-service-icon-wrap">
                        <img src="<?php echo e(asset('assets/landing/icons/file-purple.svg')); ?>" alt="Diagnostics" class="lp-icon-lg lp-icon-img">
                    </div>
                ...
                <div class="lp-contact-form-wrap">
                    <?php if(session('success')): ?>
                        <div class="lp-alert lp-alert-success">
                            <div class="lp-alert-row">
                                <img src="<?php echo e(asset('assets/landing/icons/check-green.svg')); ?>" alt="Success" class="lp-icon-sm lp-alert-icon-success lp-icon-img">
                                <p class="lp-alert-text-success"><?php echo e(session('success')); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($errors->any()): ?>
                        <div class="lp-alert lp-alert-error">
                            <div class="lp-alert-row">
                                <img src="<?php echo e(asset('assets/landing/icons/alert-red.svg')); ?>" alt="Error" class="lp-icon-sm lp-alert-icon-error lp-icon-img">
                    ...
                    <form action="<?php echo e(route('contact.store')); ?>" method="POST" class="lp-form">
                        <?php echo csrf_field(); ?>
                        <div>
                            <label for="name" class="lp-label">Your Name</label>
                            <input type="text" id="name" name="name" value="<?php echo e(old('name')); ?>" required class="lp-input <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> lp-input-error <?php unset($message);
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <p class="lp-field-error"><?php echo e($message); ?></p>
                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" required class="lp-input <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> lp-input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="subject" name="subject" value="<?php echo e(old('subject')); ?>" required class="lp-input <?php $__errorArgs = ['subject'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> lp-input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea id="message" name="message" rows="5" required class="lp-input lp-textarea <?php $__errorArgs = ['message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> lp-input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="lp-contact-info">
                    <div class="lp-contact-item">
                        <div class="lp-contact-icon-box">
                            <div class="lp-contact-icon-wrap">
                                <img src="<?php echo e(asset('assets/landing/icons/mail-accent.svg')); ?>" alt="Email" class="lp-icon-md lp-icon-img">
                            </div>
                        </div>
                    ...
                    <div class="lp-contact-item">
                        <div class="lp-contact-icon-box">
                            <div class="lp-contact-icon-wrap">
                                <img src="<?php echo e(asset('assets/landing/icons/phone-accent.svg')); ?>" alt="Phone" class="lp-icon-md lp-icon-img">
                            </div>
                        </div>
                        <div class="lp-contact-text">
                    ...
                    <div class="lp-contact-item">
                        <div class="lp-contact-icon-box">
                            <div class="lp-contact-icon-wrap">
                                <img src="<?php echo e(asset('assets/landing/icons/map-pin-accent.svg')); ?>" alt="Office" class="lp-icon-md lp-icon-img">
                            </div>
                        </div>
                        <div class="lp-contact-text">
                    ...
                    <div class="lp-social-wrap">
                        ...
                        <div class="lp-social-list">
                            <a href="#" class="lp-social-link" aria-label="Facebook">
                                <img src="<?php echo e(asset('assets/landing/icons/facebook-white.svg')); ?>" alt="Facebook" class="lp-icon-sm lp-icon-img">
                            </a>
                            <a href="#" class="lp-social-link" aria-label="Twitter">
                                <img src="<?php echo e(asset('assets/landing/icons/twitter-white.svg')); ?>" alt="Twitter" class="lp-icon-sm lp-icon-img">
                            </a>
                            <a href="#" class="lp-social-link" aria-label="Instagram">
                                <img src="<?php echo e(asset('assets/landing/icons/instagram-white.svg')); ?>" alt="Instagram" class="lp-icon-sm lp-icon-img">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="lp-container">
            <div class="lp-footer-grid">
                <div class="lp-footer-brand-col">
                    <img src="<?php echo e(asset('assets/branding/company-logo.png')); ?>" alt="AutoMate" class="lp-logo-image lp-logo-image-footer">
                ...
                <div>
                    ...
                    <ul class="lp-footer-list">
                        ...
                        <li><a href="<?php echo e(route('login')); ?>" class="lp-footer-link">Login</a></li>
                    </ul>
                </div>
                <div>
...
<?php echo $__env->make('layouts.public-core', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AutoMate\resources\views/index.blade.php ENDPATH**/ ?>