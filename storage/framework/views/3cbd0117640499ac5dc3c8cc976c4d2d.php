...
<nav id="customerNav" class="cs-cnav">
  <div class="cs-cnav-container">
    <div class="cs-cnav-row">
      ...
      <div class="cs-cnav-brand-wrap">
        <a href="<?php echo e(route('dashboard.customer')); ?>" class="cs-cnav-brand-link">
      ...
      <div class="cs-cnav-links-wrap">
        <div class="cs-cnav-links">
          <a href="<?php echo e(route('dashboard.customer')); ?>" 
             class="cs-cnav-link <?php echo e(request()->routeIs('dashboard.customer') ? 'cs-cnav-link-active' : ''); ?>">
            Dashboard
          </a>
           <a href="<?php echo e(route('bookings.index')); ?>" 
             class="cs-cnav-link <?php echo e(request()->routeIs('bookings.index') ? 'cs-cnav-link-active' : ''); ?>">
            Bookings
          ...
          <a href="<?php echo e(route('customer.vehicles')); ?>" 
             class="cs-cnav-link <?php echo e(request()->routeIs('customer.vehicles*') ? 'cs-cnav-link-active' : ''); ?>">
            Vehicles
          </a>
          <a href="<?php echo e(route('customer.rent-vehicles')); ?>" 
             class="cs-cnav-link <?php echo e(request()->routeIs('customer.rent-vehicles') ? 'cs-cnav-link-active' : ''); ?>">
            Rent Vehicles
          </a>
          <a href="<?php echo e(route('customer.rentals')); ?>" 
             class="cs-cnav-link <?php echo e(request()->routeIs('customer.rentals*') ? 'cs-cnav-link-active' : ''); ?>">
            My Rentals
      ...
      <div class="cs-cnav-actions">
        ...
        <a href="<?php echo e(route('bookings.create')); ?>" class="cs-cnav-cta">
        ...
        <a href="<?php echo e(route('customer.messages') ?? '#'); ?>" class="cs-cnav-icon-link" title="Messages">
        ...
        <a href="<?php echo e(route('notifications.index')); ?>" class="cs-cnav-icon-link">
        ...
        <div class="cs-cnav-user">
          ...
          <div id="customerUserDropdownMenu" class="cs-cnav-dropdown hidden">
            ...
            <div class="cs-cnav-dropdown-head">
              ...
              <p class="cs-cnav-dropdown-name"><?php echo e(Auth::user()->name ?? 'Customer'); ?></p>
            </div>

            <div class="cs-cnav-dropdown-body">
              <a href="<?php echo e(route('customer.profile')); ?>" class="cs-cnav-dropdown-link">
              ...
              <a href="<?php echo e(route('owner.earnings.dashboard')); ?>" class="cs-cnav-dropdown-link">
  ...
  <div id="customerMobileMenu" class="cs-cnav-mobile-menu hidden">
    ...
    <a href="<?php echo e(route('dashboard.customer')); ?>" class="cs-cnav-mobile-link">Dashboard</a>
    <a href="<?php echo e(route('customer.vehicles')); ?>" class="cs-cnav-mobile-link">My Vehicles</a>
    <a href="<?php echo e(route('bookings.create')); ?>" class="cs-cnav-mobile-link">Book Service</a>
    <a href="<?php echo e(route('bookings.index')); ?>" class="cs-cnav-mobile-link">My Bookings</a>
    <a href="<?php echo e(route('customer.messages')); ?>" class="cs-cnav-mobile-link">Messages</a>
    <a href="<?php echo e(route('customer.rent-vehicles')); ?>" class="cs-cnav-mobile-link">Rent Vehicles</a>
    <a href="<?php echo e(route('customer.rentals')); ?>" class="cs-cnav-mobile-link">My Rentals</a>
    <a href="<?php echo e(route('customer.profile')); ?>" class="cs-cnav-mobile-link">Profile</a>
