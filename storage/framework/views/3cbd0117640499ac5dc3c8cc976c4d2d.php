        ...
        <div class="flex items-center space-x-2">
          <a href="<?php echo e(route('dashboard.customer')); ?>" 
           ...
           <a href="<?php echo e(route('bookings.index')); ?>" 
             class="px-5 py-2.5 rounded-xl text-sm font-bold transition-all duration-200 <?php echo e(request()->routeIs('bookings.index') ? 'text-[#ff5a1f] bg-orange-50' : 'text-gray-600 hover:text-[#ff5a1f] hover:bg-gray-50'); ?>">
            Bookings
        ...
        <div class="relative">
          ...
          <div x-show="userDropdownOpen" 
            ...
            <div class="p-2 space-y-1">
              ...
              <a href="<?php echo e(route('owner.earnings.dashboard')); ?>" class="flex items-center px-4 py-3 rounded-xl text-sm font-bold text-gray-700 hover:bg-orange-50 hover:text-[#ff5a1f] transition-all">
