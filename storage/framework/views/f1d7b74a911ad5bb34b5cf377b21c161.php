        ...
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 p-8">
            <div class="text-center">
                ...
                <div class="border-t border-gray-100 pt-6 space-y-3">
                    ...
                    <a href="<?php echo e(route('index')); ?>" class="w-full flex justify-center py-3 px-4 border border-gray-300 rounded-xl shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#ff5a1f] transition-colors">
                        Return to Home
                    </a>
                </div>
            </div>
