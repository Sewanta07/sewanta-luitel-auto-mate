...
<div class="ap-page ap-page-register">
    <div class="ap-register-head">
        ...
        <p class="ap-auth-subtitle ap-auth-subtitle-center">
            ...
            <a href="<?php echo e(route('login')); ?>" class="ap-link">Sign in instead</a>
        </p>
    </div>

    <div class="ap-register-card">
        <form method="POST" action="<?php echo e(route('register')); ?>" class="ap-form">
            <?php echo csrf_field(); ?>
            ...
            <div class="ap-grid ap-grid-2">
                <div class="ap-field">
                    ...
                    <input type="text" name="name" id="name" autocomplete="name" required class="ap-input" value="<?php echo e(old('name')); ?>" placeholder="John Doe">
                </div>

                <div class="ap-field">
                    <label for="phone" class="ap-label">Phone Number</label>
                    <input type="tel" name="phone" id="phone" autocomplete="tel" required class="ap-input" value="<?php echo e(old('phone')); ?>" placeholder="+1 (555) 000-0000">
                </div>
            </div>

            <div class="ap-field">
                <label for="email" class="ap-label">Email Address</label>
                <input id="email" name="email" type="email" autocomplete="email" required class="ap-input" value="<?php echo e(old('email')); ?>" placeholder="you@example.com">
            </div>

            <div class="ap-field">
                <label for="current_address" class="ap-label">Current Address</label>
                <textarea id="current_address" name="current_address" rows="2" required class="ap-input ap-textarea" placeholder="123 Main St, Apt 4B"><?php echo e(old('current_address')); ?></textarea>
            </div>
                ...
                <div class="ap-field">
                    ...
                    <div class="ap-input-wrap">
                        ...
                        <button type="button" onclick="togglePasswordVisibility('password_confirmation', 'password_confirmation-toggle')" class="ap-password-toggle" aria-label="Toggle confirm password visibility">
                            <img src="<?php echo e(asset('assets/auth/icons/eye.svg')); ?>" id="password_confirmation-toggle" alt="Show password" class="ap-icon-sm ap-icon-img ap-password-icon">
                        </button>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.public-core', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AutoMate\resources\views/auth/register.blade.php ENDPATH**/ ?>