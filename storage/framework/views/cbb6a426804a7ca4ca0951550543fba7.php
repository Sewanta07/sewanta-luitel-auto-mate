                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 transition-colors group">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <?php if($log->notes): ?>
                                        <div class="text-xs text-gray-500 mt-1 line-clamp-2"><?php echo e(Str::limit($log->notes, 60)); ?></div>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm font-bold text-gray-900">Rs. <?php echo e(number_format($log->booking->estimated_cost ?? 0, 2)); ?></span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <a href="<?php echo e(route('staff.bookings.show', $log->booking->id)); ?>" class="inline-flex items-center gap-1 px-3 py-2 rounded-lg bg-orange-50 text-orange-600 hover:bg-orange-100 transition font-bold text-sm">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AutoMate\resources\views\staff\service-logs-new.blade.php ENDPATH**/ ?>