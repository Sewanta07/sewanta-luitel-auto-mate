...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 pb-12">
    <main class="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div class="mb-8 mt-4">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                ...
                <div class="flex gap-2">
                    <a href="<?php echo e(route('staff.service.logs')); ?>" class="px-4 py-3 rounded-lg bg-gradient-to-r from-orange-500 to-orange-600 text-white hover:shadow-lg transition font-bold flex items-center gap-2 shadow-lg">
            ...
            <div class="bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow border border-gray-100 p-6 transform hover:-translate-y-1">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-black text-green-600 mt-2"><?php echo e($totalServices); ?></p>
            ...
            <div class="bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow border border-gray-100 p-6 transform hover:-translate-y-1">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-black text-blue-600 mt-2">Rs. <?php echo e(number_format($totalCost, 0)); ?></p>
        ...
        <div class="bg-white rounded-2xl shadow-md border border-gray-100 p-6 mb-8">
            ...
            <form action="<?php echo e(route('staff.service.logs')); ?>" method="GET" class="grid grid-cols-1 sm:grid-cols-4 gap-4">
                <div>
                    <label class="block text-xs font-black text-gray-500 uppercase tracking-wider mb-2">Search</label>
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Booking ref, vehicle..." class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 text-sm font-medium outline-none transition">
                </div>
                <div>
                    <label class="block text-xs font-black text-gray-500 uppercase tracking-wider mb-2">From Date</label>
                    <input type="date" name="date_from" value="<?php echo e(request('date_from')); ?>" class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 text-sm font-medium outline-none transition">
                </div>
                <div>
                    <label class="block text-xs font-black text-gray-500 uppercase tracking-wider mb-2">To Date</label>
                    <input type="date" name="date_to" value="<?php echo e(request('date_to')); ?>" class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 text-sm font-medium outline-none transition">
                </div>
                <div class="flex items-end gap-2">
                    ...
                    <a href="<?php echo e(route('staff.service.logs')); ?>" class="w-full text-center px-6 py-3 bg-gray-100 text-gray-700 font-bold rounded-lg hover:bg-gray-200 transition">Reset</a>
                </div>
            </form>
        </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 transition-colors group">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-bold text-gray-900"><?php echo e($log->created_at->format('M d, Y')); ?></div>
                                    <div class="text-xs text-gray-500"><?php echo e($log->created_at->format('h:i A')); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-block px-3 py-1 rounded-full bg-blue-50 text-blue-700 font-black text-sm"><?php echo e($log->booking->booking_code); ?></span>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm font-bold text-gray-900"><?php echo e($log->booking->vehicle_model); ?></div>
                                    <div class="text-xs text-gray-500 font-mono"><?php echo e($log->booking->vehicle_number); ?></div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900 font-medium"><?php echo e($log->booking->service_type); ?></div>
                                    <?php if($log->notes): ?>
                                        <div class="text-xs text-gray-500 mt-1"><?php echo e(\Illuminate\Support\Str::limit($log->notes, 70)); ?></div>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm font-bold text-gray-900">Rs. <?php echo e(number_format((float) ($log->booking->total_amount ?? $log->booking->estimated_cost ?? 0), 2)); ?></span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <a href="<?php echo e(route('staff.services.show', $log->booking->id)); ?>" class="inline-flex items-center gap-1 px-3 py-2 rounded-lg bg-orange-50 text-orange-600 hover:bg-orange-100 transition font-bold text-sm">
                ...
                <div class="bg-gray-50 px-6 py-4 border-t border-gray-100">
                    <div class="flex items-center justify-between">
                        <div class="text-sm text-gray-600">
                            Showing <span class="font-bold"><?php echo e($logs->firstItem()); ?></span> to <span class="font-bold"><?php echo e($logs->lastItem()); ?></span> of <span class="font-bold"><?php echo e($logs->total()); ?></span> results
                        </div>
                        <div class="flex gap-2">
                            <?php if($logs->onFirstPage()): ?>
                                <button disabled class="px-4 py-2 rounded-lg bg-gray-200 text-gray-400 font-bold">← Previous</button>
                            <?php else: ?>
                                <a href="<?php echo e($logs->previousPageUrl()); ?>" class="px-4 py-2 rounded-lg border-2 border-gray-300 text-gray-700 hover:border-orange-500 hover:text-orange-600 font-bold transition">← Previous</a>
                            <?php endif; ?>

                            <?php if($logs->hasMorePages()): ?>
                                <a href="<?php echo e($logs->nextPageUrl()); ?>" class="px-4 py-2 rounded-lg bg-orange-500 text-white font-bold hover:bg-orange-600 transition">Next →</a>
                            <?php else: ?>
