        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition duration-300 flex flex-col">
            <div class="relative h-44 bg-gray-100">
                <?php if($vehicle->image_path): ?>
                    <img src="<?php echo e(asset('storage/' . $vehicle->image_path)); ?>" alt="<?php echo e($vehicle->vehicle_name ?? $vehicle->brand); ?>" class="w-full h-full object-cover">
                <?php else: ?>
                ...
                <?php endif; ?>
                <span class="absolute top-3 right-3 inline-flex items-center px-3 py-1 rounded-full text-xs font-bold <?php echo e($status['badge_bg']); ?> <?php echo e($status['badge_text']); ?> shadow-sm">
                    <span class="w-1.5 h-1.5 rounded-full <?php echo e($status['dot_color']); ?> mr-2"></span>
            ...
            <div class="p-6 flex-1">
                <div class="flex items-start justify-between mb-4">
                    <div class="p-3 rounded-2xl" style="background-color: <?php echo e($badgeBgColor); ?>;">
                        <svg class="w-8 h-8" style="color: <?php echo e($badgeIconColor); ?>;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0zM13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0 a2 2 0 114 0"></path>
                        </svg>
                    </div>
                    <div class="text-right">
                        <p class="text-xs text-gray-500"><?php echo e($vehicle->vehicle_type ?? 'Vehicle'); ?></p>
                        <p class="text-xs text-gray-400"><?php echo e($vehicle->fuel_type ?? 'Fuel N/A'); ?> • <?php echo e($vehicle->transmission_type ?? 'Transmission N/A'); ?></p>
                    </div>
                </div>
                ...
                <p class="text-sm text-gray-500 mb-2"><?php echo e($vehicle->brand); ?> <?php echo e($vehicle->model); ?> • <?php echo e($vehicle->year); ?></p>
                
                <?php if($vehicle->daily_rate): ?>
                    <p class="text-sm text-[#ff5a1f] font-semibold mb-3">Rs. <?php echo e(number_format($vehicle->daily_rate, 2)); ?> / day</p>
                <?php endif; ?>
            ...
            <div class="px-6 py-4 bg-gray-50/50 border-t border-gray-50 space-y-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        <a href="<?php echo e(route('vehicles.edit', $vehicle->id)); ?>" class="text-gray-400 hover:text-blue-600 transition" title="Edit Vehicle">
                        ...
                        <form action="<?php echo e(route('vehicles.destroy', $vehicle->id)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to remove this vehicle?');">
                            ...
                            <button type="submit" class="text-gray-400 hover:text-red-500 transition" title="Remove Vehicle" <?php echo e($vehicle->rented_by_user_id ? 'disabled' : ''); ?>>
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                            </button>
                        </form>
                    </div>
                    <a href="<?php echo e(route('bookings.create', ['vehicle_id' => $vehicle->id])); ?>" class="text-sm font-bold text-[#ff5a1f] hover:text-[#e64b15] transition flex items-center">
                        Request Service
                    ...
                    <div class="bg-white rounded-xl border border-gray-100 p-3">
                        ...
                        <div class="space-y-2">
                            <?php $__currentLoopData = $vehicle->rentalRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between">
                                    <span class="text-xs text-gray-600">Request #<?php echo e($request->id); ?></span>
                ...
                <form action="<?php echo e(route('vehicles.toggle-rent', $vehicle->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <button type="submit" class="w-full px-4 py-2 rounded-xl text-sm font-bold transition <?php echo e($vehicle->is_listed_for_rent ? 'bg-purple-100 text-purple-700 hover:bg-purple-200' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>" <?php echo e($vehicle->rented_by_user_id ? 'disabled' : ''); ?>>
...
<?php else: ?>
    <div class="col-span-full py-20 bg-white rounded-3xl border border-dashed border-gray-200 flex flex-col items-center justify-center text-center px-4">
        ...
        <h3 class="text-2xl font-bold text-gray-900 mb-2"><?php echo e($showAll ? "You haven't added any vehicles yet" : "You haven't listed any vehicles for rent yet"); ?></h3>
