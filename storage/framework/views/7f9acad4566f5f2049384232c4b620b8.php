    ...
    <div class="max-w-2xl w-full">
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="px-8 py-6 bg-gray-50 border-t border-gray-200 flex flex-col sm:flex-row gap-3 justify-center">
                <a href="<?php echo e($redirectUrl); ?>" class="inline-flex items-center justify-center px-8 py-3 rounded-xl bg-[#ff5a1f] text-white font-bold hover:bg-[#e64b15] transition-all shadow-lg hover:shadow-xl">
