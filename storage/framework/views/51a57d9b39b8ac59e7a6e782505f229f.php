<nav class="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center h-16">
      ...
      <div class="hidden md:flex md:items-center md:space-x-1">
        ...
        <a href="<?php echo e(route('admin.vehicles')); ?>" class="px-3 py-2 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('admin.vehicles') ? 'bg-orange-50 text-[#ff5a1f]' : 'text-gray-700 hover:bg-gray-100'); ?> transition">
            Fleet
        </a>
      ...
      <div class="flex items-center space-x-3">
        <a href="<?php echo e(route('admin.settings')); ?>" class="p-2 rounded-lg text-gray-500 hover:bg-gray-100 hover:text-[#ff5a1f] transition" title="Settings">
  ...
  <div class="md:hidden hidden bg-white border-t border-gray-200 px-4 py-3 space-y-2">
    ...
    <a href="<?php echo e(route('admin.vehicles')); ?>" class="block px-3 py-2 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-100">Fleet</a>
    ...
    <a href="<?php echo e(route('admin.settings')); ?>" class="block px-3 py-2 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-100">Settings</a>
  </div>
</nav>
