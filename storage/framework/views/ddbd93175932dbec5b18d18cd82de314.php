            ...
            <div class="mt-6 border-t border-gray-100 pt-5">
                ...
                <div class="cs-invoice-summary bg-gray-50 border border-gray-100 rounded-2xl p-4 space-y-3">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <p class="text-sm font-bold text-gray-900 text-right">Service Rs. <?php echo e(number_format($booking->service_cost ?? 0, 2)); ?> + Spare Rs. <?php echo e(number_format($booking->spare_parts_cost ?? 0, 2)); ?> + Parts Rs. <?php echo e(number_format($partsTotal, 2)); ?></p>
                    </div>
                    <div class="flex items-center justify-between">
...
<?php echo $__env->make('layouts.customer-core', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AutoMate\resources\views/customer/bookings/invoice.blade.php ENDPATH**/ ?>