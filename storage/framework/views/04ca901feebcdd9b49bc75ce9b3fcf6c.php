<div class="hidden md:flex flex-col w-64 bg-white border-r border-gray-200 h-full fixed left-0 top-0 z-30">
    ...
    <div class="flex-1 overflow-y-auto py-6 flex flex-col justify-between">
        <nav class="space-y-1 px-4">
            ...
            <a href="<?php echo e(route('admin.transactions')); ?>" class="group flex items-center px-3 py-2.5 text-sm font-medium rounded-xl transition <?php echo e(request()->routeIs('admin.transactions*') ? 'bg-orange-50 text-[#ff5a1f]' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
...
<?php if (! $__env->hasRenderedOnce('355ac3b8-1374-4712-af29-35ac035fdf05')): $__env->markAsRenderedOnce('355ac3b8-1374-4712-af29-35ac035fdf05'); ?>
