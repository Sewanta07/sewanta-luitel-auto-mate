                ...
                <td class="px-6 py-4">
                  <div class="flex items-center gap-3">
                    <div class="w-24 bg-gray-200 rounded-full h-2">
                      <div class="bg-gradient-to-r <?php echo e($item->stock_status === 'out_of_stock' ? 'from-red-500 to-red-600' : ($item->stock_status === 'low_stock' ? 'from-orange-500 to-orange-600' : 'from-green-500 to-green-600')); ?> h-2 rounded-full <?php echo e($stockWidthClass); ?>"></div>
                    </div>
