                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition duration-300 flex flex-col">
                    <div class="p-6 flex-1">
                        <div class="flex items-start justify-between mb-4">
                            <div class="p-3 rounded-2xl" style="background-color: <?php echo e($status['badge_color'] === 'blue' ? '#eff6ff' : '#f0fdf4'); ?>;">
                                <svg class="w-8 h-8" style="color: <?php echo e($status['badge_color'] === 'blue' ? '#2563eb' : '#10b981'); ?>;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0zM13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0"></path>
                                </svg>
                            </div>
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold <?php echo e($status['badge_bg']); ?> <?php echo e($status['badge_text']); ?>">
                                <span class="w-1.5 h-1.5 rounded-full <?php echo e($status['dot_color']); ?> mr-2"></span>
                                <?php echo e($status['status']); ?>

                            </span>
                        </div>
                        <h3 class="text-xl font-bold text-gray-900 mb-1"><?php echo e($vehicle->brand); ?></h3>
                        <p class="text-sm text-gray-500 mb-4"><?php echo e($vehicle->model); ?> • <?php echo e($vehicle->year); ?></p>
                    ...
                    <div class="px-6 py-4 bg-gray-50/50 border-t border-gray-50 flex items-center justify-between">
                        ...
                        <a href="<?php echo e(route('bookings.create')); ?>" class="text-sm font-bold text-[#ff5a1f] hover:text-[#e64b15] transition flex items-center">
                            Request Service
...
<div id="vehicle-modal-backdrop" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-[60] hidden flex items-center justify-center p-4">
    <div id="vehicle-modal" class="bg-white rounded-3xl shadow-2xl max-w-lg w-full transform scale-95 opacity-0 transition-all duration-300">
        <div class="p-6 sm:p-8">
            ...
            <form action="<?php echo e(route('vehicles.store')); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AutoMate\resources\views\customer\vehicles\index_new.blade.php ENDPATH**/ ?>