        ...
        <div class="ad-sinv-panel">
            <div class="ad-sinv-head">
                <div>
                    ...
                    <p class="ad-sinv-subtitle">Booking <?php echo e($booking->booking_code); ?></p>
                </div>
                <span class="ad-sinv-badge ad-sinv-badge-green"><?php echo e($booking->status); ?></span>
            </div>

            <div class="ad-sinv-grid-2">
                <div>
                    <p class="ad-sinv-meta-label">Customer</p>
                    <p class="ad-sinv-meta-title"><?php echo e($booking->customer->name ?? 'N/A'); ?></p>
                    <p class="ad-sinv-meta-subtitle"><?php echo e($booking->customer->email ?? 'N/A'); ?></p>
                </div>
                <div>
                    <p class="ad-sinv-meta-label">Staff</p>
                    <p class="ad-sinv-meta-title"><?php echo e($booking->staff->name ?? 'Unassigned'); ?></p>
                    <p class="ad-sinv-meta-subtitle"><?php echo e($booking->staff->email ?? ''); ?></p>
                </div>
                <div>
                    <p class="ad-sinv-meta-label">Vehicle</p>
                    <p class="ad-sinv-meta-title"><?php echo e($booking->vehicle_model); ?></p>
                    <p class="ad-sinv-meta-subtitle"><?php echo e($booking->vehicle_number); ?> • <?php echo e($booking->vehicle_type); ?></p>
                </div>
                <div>
                    <p class="ad-sinv-meta-label">Service</p>
                    <p class="ad-sinv-meta-title"><?php echo e($booking->service_type); ?></p>
                    <p class="ad-sinv-meta-subtitle"><?php echo e(\Carbon\Carbon::parse($booking->preferred_date)->format('M d, Y')); ?> • <?php echo e($booking->preferred_time_slot); ?></p>
                </div>
                <div>
                    <p class="ad-sinv-meta-label">Priority</p>
                    <p class="ad-sinv-meta-small"><?php echo e($booking->service_priority); ?></p>
                </div>
                <div>
                    <p class="ad-sinv-meta-label">Location</p>
                    <p class="ad-sinv-meta-small"><?php echo e($booking->service_location_type); ?></p>
                </div>
            </div>
                    ...
                    <table class="ad-sinv-table">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $booking->parts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td class="ad-sinv-align-center ad-sinv-muted"><?php echo e($part->pivot->quantity); ?></td>
                                    <td class="ad-sinv-align-right ad-sinv-muted">Rs. <?php echo e(number_format($part->pivot->unit_price, 2)); ?></td>
                                    <td class="ad-sinv-align-right ad-sinv-strong">Rs. <?php echo e(number_format($part->pivot->total_cost, 2)); ?></td>
                                </tr>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="ad-sinv-align-right ad-sinv-accent">Rs. <?php echo e(number_format($partsTotal, 2)); ?></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
            ...
            <div class="ad-sinv-section">
                <div class="ad-sinv-summary-row">
                    ...
                    <p class="ad-sinv-summary-value">Rs. <?php echo e(number_format($booking->service_cost ?? 0, 2)); ?></p>
                </div>
                <div class="ad-sinv-summary-row ad-sinv-summary-row-gap">
                    <p class="ad-sinv-summary-label">Spare Parts Cost</p>
                    <p class="ad-sinv-summary-value">Rs. <?php echo e(number_format($booking->spare_parts_cost ?? 0, 2)); ?></p>
                </div>
                <div class="ad-sinv-summary-row ad-sinv-summary-row-total">
                    <p class="ad-sinv-summary-label">Total Payable</p>
                    <p class="ad-sinv-total">Rs. <?php echo e(number_format($displayTotal, 2)); ?></p>
                </div>
                <div class="ad-sinv-summary-row ad-sinv-summary-row-total">
                    <p class="ad-sinv-summary-label">Payment Status</p>
                    <span class="ad-sinv-badge <?php echo e(($booking->payment_status ?? 'pending') === 'paid' ? 'ad-sinv-badge-green' : 'ad-sinv-badge-yellow'); ?>">
            ...
            <div class="ad-sinv-actions">
                <a href="<?php echo e(route('admin.services')); ?>" class="ad-sinv-back-btn">Back to Services</a>
            </div>
        </div>
    </div>
</div>
