    ...
    <main class="max-w-7xl mx-auto p-6 grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <section class="lg:col-span-3 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <a href="<?php echo e(route('customer.payments')); ?>" class="p-4 rounded-xl bg-white shadow-sm hover:shadow-md transition border-l-4" style="border-left-color: #10b981;">
