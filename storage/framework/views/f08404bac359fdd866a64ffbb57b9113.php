...
<div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <a href="<?php echo e(route('index')); ?>" class="flex justify-center mb-6">
        ...
        <div class="bg-white py-8 px-4 shadow-xl shadow-gray-100 sm:rounded-3xl sm:px-10 border border-gray-100 text-center">
            ...
            <p class="text-gray-500 mb-8"><?php echo e(session('message', 'Your account has been created successfully.')); ?></p>
