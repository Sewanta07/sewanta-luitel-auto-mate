...
<div class="cs-page cs-vehicles-edit-page min-h-screen bg-gray-50 pb-12">
    <main class="cs-vehicles-edit-main max-w-3xl mx-auto p-4 sm:p-6 lg:p-8">
        <a href="<?php echo e(route('customer.vehicles')); ?>" class="cs-vehicles-edit-back inline-flex items-center text-sm font-bold text-gray-400 hover:text-[#ff5a1f] transition-colors mb-6">
        ...
        <div class="cs-vehicles-edit-card bg-white rounded-[2rem] shadow-lg p-8 border border-gray-100">
            ...
            <form action="<?php echo e(route('vehicles.update', $vehicle->id)); ?>" method="POST" enctype="multipart/form-data" class="cs-vehicles-edit-form space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="cs-vehicles-edit-grid grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div class="cs-vehicles-edit-field cs-vehicles-edit-field-full sm:col-span-2">
                        ...
                        <input type="text" name="vehicle_name" value="<?php echo e(old('vehicle_name', $vehicle->vehicle_name)); ?>" class="cs-vehicles-edit-control block w-full px-4 py-3 rounded-xl border-gray-200 focus:border-[#ff5a1f] focus:ring-[#ff5a1f] transition duration-200">
                    </div>
                    <div class="cs-vehicles-edit-field">
                        ...
                        <input type="text" name="brand" value="<?php echo e(old('brand', $vehicle->brand)); ?>" required class="cs-vehicles-edit-control block w-full px-4 py-3 rounded-xl border-gray-200 focus:border-[#ff5a1f] focus:ring-[#ff5a1f] transition duration-200">
                    </div>
                    <div class="cs-vehicles-edit-field">
                        ...
                        <input type="text" name="model" value="<?php echo e(old('model', $vehicle->model)); ?>" required class="cs-vehicles-edit-control block w-full px-4 py-3 rounded-xl border-gray-200 focus:border-[#ff5a1f] focus:ring-[#ff5a1f] transition duration-200">
                    </div>
                    <div class="cs-vehicles-edit-field">
                        ...
                        <input type="number" name="year" value="<?php echo e(old('year', $vehicle->year)); ?>" required min="1900" max="<?php echo e(date('Y')); ?>" class="cs-vehicles-edit-control block w-full px-4 py-3 rounded-xl border-gray-200 focus:border-[#ff5a1f] focus:ring-[#ff5a1f] transition duration-200">
                    </div>
                    <div class="cs-vehicles-edit-field">
                    ...
                    <div class="cs-vehicles-edit-field cs-vehicles-edit-field-full sm:col-span-2">
                        ...
                        <input type="text" name="plate_number" value="<?php echo e(old('plate_number', $vehicle->plate_number)); ?>" required class="cs-vehicles-edit-control cs-vehicles-edit-control-mono block w-full px-4 py-3 rounded-xl border-gray-200 focus:border-[#ff5a1f] focus:ring-[#ff5a1f] font-mono transition duration-200 uppercase">
                    </div>
                    <div class="cs-vehicles-edit-field">
                    ...
                    <div class="cs-vehicles-edit-field cs-vehicles-edit-field-full sm:col-span-2">
                        ...
                        <input type="number" name="daily_rate" step="0.01" min="0" value="<?php echo e(old('daily_rate', $vehicle->daily_rate)); ?>" class="cs-vehicles-edit-control block w-full px-4 py-3 rounded-xl border-gray-200 focus:border-[#ff5a1f] focus:ring-[#ff5a1f] transition duration-200">
                    </div>
                </div>
                ...
                <div class="cs-vehicles-edit-actions flex flex-col sm:flex-row items-center justify-end space-y-3 sm:space-y-0 sm:space-x-4 pt-6">
                    <a href="<?php echo e(route('customer.vehicles')); ?>" class="cs-vehicles-edit-cancel w-full sm:w-auto px-6 py-3 rounded-xl border border-gray-200 text-gray-700 font-semibold hover:bg-gray-50 transition text-center">
                        Cancel
                    </a>
...
<?php echo $__env->make('layouts.customer-core', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AutoMate\resources\views\customer\vehicles\edit.blade.php ENDPATH**/ ?>