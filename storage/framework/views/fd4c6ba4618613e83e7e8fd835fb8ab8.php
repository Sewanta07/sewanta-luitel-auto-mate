...
<?php $__env->startSection('title', 'Rent a Car - AutoMate'); ?>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 mb-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                    ...
                    <input type="date" id="pickup_date" class="block w-full px-4 py-2.5 rounded-xl border-gray-200 focus:border-[#ff5a1f] focus:ring-[#ff5a1f] text-sm transition" value="<?php echo e(date('Y-m-d')); ?>">
                </div>
                <div>
