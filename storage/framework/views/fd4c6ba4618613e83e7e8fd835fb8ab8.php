...
<?php $__env->startSection('title', 'My Rentals - AutoMate'); ?>
  ...
  <main class="cs-page cs-rentals-page cs-rentals-main max-w-7xl mx-auto p-6">
          ...
          <div class="cs-rental-card cs-surface bg-white rounded-2xl border border-gray-100 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-start justify-between">
              <div class="flex-1">
                ...
                <p class="cs-rental-plate text-sm text-gray-500 mb-2"><?php echo e($request->vehicle?->plate_number); ?></p>
                ...
                <div class="cs-meta-grid grid grid-cols-2 md:grid-cols-4 gap-4 mb-3">
                  <div class="cs-rental-meta-item">
                    ...
                    <p class="cs-rental-meta-value text-sm font-bold text-gray-900"><?php echo e($request->number_of_days ?? 0); ?> days</p>
                  </div>
                  <div class="cs-rental-meta-item">
                    <p class="cs-rental-meta-label text-xs text-gray-500">Start Date</p>
                    <p class="cs-rental-meta-value text-sm font-bold text-gray-900"><?php echo e($request->start_date ? $request->start_date->format('M d, Y') : 'N/A'); ?></p>
                  </div>
                  <div class="cs-rental-meta-item">
                    <p class="cs-rental-meta-label text-xs text-gray-500">End Date</p>
                    <p class="cs-rental-meta-value text-sm font-bold text-gray-900"><?php echo e($request->end_date ? $request->end_date->format('M d, Y') : 'N/A'); ?></p>
                  </div>
                  <div class="cs-rental-meta-item">
                    <p class="cs-rental-meta-label text-xs text-gray-500">Total Cost</p>
                    <p class="cs-rental-meta-value text-sm font-bold text-orange-600">Rs. <?php echo e(number_format($request->total_cost ?? 0, 2)); ?></p>
                  </div>
                </div>
                ...
                <?php if($request->assignedStaff): ?>
                  <div class="cs-note cs-note-info bg-blue-50 border border-blue-100 rounded-lg p-3 mb-3">
                    ...
                    <p class="cs-note-text text-sm text-blue-900"><?php echo e($request->assignedStaff->user->name ?? 'N/A'); ?></p>
                  </div>
                <?php endif; ?>
                ...
                <?php if($request->has_damage): ?>
                  <div class="cs-note cs-note-danger bg-red-50 border border-red-100 rounded-lg p-3 mb-3">
                    ...
                    <p class="cs-note-text text-sm text-red-900">Charge: Rs. <?php echo e(number_format($request->damage_charge ?? 0, 2)); ?></p>
                    <p class="cs-note-subtext text-xs text-red-700 mt-1">Payment: <?php echo e($request->damage_payment_status ?? 'Unpaid'); ?></p>
                    <?php if($request->damage_description): ?>
                      <p class="cs-note-desc text-xs text-gray-600 mt-2"><?php echo e($request->damage_description); ?></p>
                    <?php endif; ?>
                  </div>
                <?php endif; ?>
              ...
              <div class="cs-rental-actions flex flex-col gap-2 ml-4">
                ...
                <?php if(strtolower((string) ($request->payment_status ?? '')) === 'paid' && isset($requestPaymentIds[$request->id])): ?>
                  <a href="<?php echo e(route('payments.receipt', $requestPaymentIds[$request->id])); ?>" class="cs-btn cs-btn-muted cs-btn-sm px-4 py-2 rounded-lg text-sm font-bold bg-gray-100 text-gray-700 hover:bg-gray-200 transition text-center">View Receipt</a>
                <?php endif; ?>
          ...
          <div class="cs-rental-card cs-surface bg-white rounded-2xl border border-gray-100 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-start justify-between">
              <div class="flex-1">
                ...
                <p class="cs-rental-plate text-sm text-gray-500 mb-2"><?php echo e($rental->vehicle?->plate_number); ?></p>

                <div class="cs-meta-grid grid grid-cols-2 md:grid-cols-4 gap-4 mb-3">
                  <div class="cs-rental-meta-item">
                    <p class="cs-rental-meta-label text-xs text-gray-500">Duration</p>
                    <p class="cs-rental-meta-value text-sm font-bold text-gray-900"><?php echo e($rental->number_of_days ?? 0); ?> days</p>
                  </div>
                  <div class="cs-rental-meta-item">
                    <p class="cs-rental-meta-label text-xs text-gray-500">Start Date</p>
                    <p class="cs-rental-meta-value text-sm font-bold text-gray-900"><?php echo e($rental->start_date ? $rental->start_date->format('M d, Y') : 'N/A'); ?></p>
                  </div>
                  <div class="cs-rental-meta-item">
                    <p class="cs-rental-meta-label text-xs text-gray-500">End Date</p>
                    <p class="cs-rental-meta-value text-sm font-bold text-gray-900"><?php echo e($rental->end_date ? $rental->end_date->format('M d, Y') : 'N/A'); ?></p>
                  </div>
                  <div class="cs-rental-meta-item">
                    <p class="cs-rental-meta-label text-xs text-gray-500">Total Amount</p>
                    <p class="cs-rental-meta-value text-sm font-bold text-orange-600">Rs. <?php echo e(number_format($rental->total_amount, 2)); ?></p>
                  </div>
                </div>
                ...
                <?php if($rental->damage_charge && $rental->damage_charge > 0): ?>
                  <div class="cs-note cs-note-danger bg-red-50 border border-red-100 rounded-lg p-3 mb-3">
                    ...
                    <p class="cs-note-text text-sm text-red-900">Rs. <?php echo e(number_format($rental->damage_charge, 2)); ?></p>
                    <?php if($rental->damage_notes): ?>
                      <p class="cs-note-desc text-xs text-gray-600 mt-1"><?php echo e($rental->damage_notes); ?></p>
                    <?php endif; ?>
                  </div>
                <?php endif; ?>
              ...
              <div class="cs-rental-actions flex flex-col gap-2 ml-4">
                ...
                <?php elseif(isset($rentalPaymentIds[$rental->id])): ?>
                  <a href="<?php echo e(route('payments.receipt', $rentalPaymentIds[$rental->id])); ?>" class="cs-btn cs-btn-muted cs-btn-sm px-4 py-2 rounded-lg text-sm font-bold bg-gray-100 text-gray-700 hover:bg-gray-200 transition text-center">View Receipt</a>
                <?php endif; ?>
              </div>
            </div>
          </div>
    ...
    <?php if((!isset($requests) || $requests->count() === 0) && (!isset($rentals) || $rentals->count() === 0)): ?>
      <div class="cs-empty-state cs-surface bg-white rounded-2xl border border-dashed border-gray-200 p-10 text-center">
        ...
        <a href="<?php echo e(route('customer.rent-vehicles')); ?>" class="cs-btn cs-btn-primary inline-flex items-center mt-6 px-6 py-3 rounded-xl bg-[#ff5a1f] text-white font-bold hover:bg-[#e64b15] transition">
...
<?php echo $__env->make('layouts.customer-core', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AutoMate\resources\views/customer/rentals.blade.php ENDPATH**/ ?>