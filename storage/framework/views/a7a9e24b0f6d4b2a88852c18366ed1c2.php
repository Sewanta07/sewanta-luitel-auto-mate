    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8 mb-10">
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
        <div>
          ...
          <h1 class="text-3xl sm:text-4xl font-black text-gray-900 mt-2">Booking <?php echo e($booking->booking_code); ?></h1>
        ...
        <div class="flex items-center gap-4">
          <span class="inline-flex items-center px-4 py-2 rounded-full font-black text-xs uppercase tracking-widest shadow
            <?php if($booking->status == 'Pending'): ?> bg-yellow-100 text-yellow-800 border border-yellow-200
            <?php elseif($booking->status == 'Assigned'): ?> bg-blue-100 text-blue-800 border border-blue-200
            <?php elseif($booking->status == 'Customer Accepted'): ?> bg-cyan-100 text-cyan-800 border border-cyan-200
            <?php elseif($booking->status == 'In Progress'): ?> bg-purple-100 text-purple-800 border border-purple-200
            <?php elseif($booking->status == 'Waiting for Parts'): ?> bg-orange-100 text-orange-800 border border-orange-200
            <?php elseif($booking->status == 'Completed'): ?> bg-green-100 text-green-800 border border-green-200
      ...
      <div class="space-y-8">
          ...
          <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-orange-500 hover:shadow-lg transition-shadow">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                ...
                <p class="font-bold text-gray-900 text-base"><?php echo e($booking->customer->name ?? 'Unknown'); ?></p>
              </div>
              <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                <p class="text-[10px] text-gray-400 font-black uppercase tracking-wider mb-1">Contact Number</p>
                <p class="font-bold text-gray-900 text-base"><?php echo e($booking->phone_number ?? ($booking->customer->phone ?? 'N/A')); ?></p>
              </div>
              <div class="bg-gray-50 rounded-xl p-4 border border-gray-100 sm:col-span-2">
                ...
                <p class="font-bold text-gray-900 text-sm break-all"><?php echo e($booking->customer->email ?? 'N/A'); ?></p>
              </div>
              <div class="bg-gray-50 rounded-xl p-4 border border-gray-100 sm:col-span-2">
                <p class="text-[10px] text-gray-400 font-black uppercase tracking-wider mb-1">Service Location</p>
                <p class="font-bold text-gray-900 text-base"><?php echo e($booking->location); ?></p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-500 hover:shadow-lg transition-shadow">
            ...
            <div class="space-y-4">
              <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                ...
                <p class="font-bold text-gray-900 text-base"><?php echo e($booking->vehicle_model); ?></p>
              </div>
              <div class="bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-4 text-center">
                ...
                <p class="font-black text-gray-900 text-xl tracking-wider"><?php echo e($booking->vehicle_number); ?></p>
              </div>
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                  <p class="text-[10px] text-gray-400 font-black uppercase tracking-wider mb-1">Vehicle Type</p>
                  <p class="font-bold text-gray-900 text-base"><?php echo e($booking->vehicle_type); ?></p>
                </div>
                <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                  <p class="text-[10px] text-gray-400 font-black uppercase tracking-wider mb-1">Year of Manufacture</p>
                  <p class="font-bold text-gray-900 text-base"><?php echo e($booking->vehicle_year ?? 'N/A'); ?></p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="bg-white rounded-2xl shadow-md border border-gray-100 p-10 hover:shadow-lg transition-shadow">
          ...
          <form action="<?php echo e(route('staff.services.parts.add', $booking->id)); ?>" method="POST" class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <?php echo csrf_field(); ?>
            <div>
              ...
              <select name="inventory_item_id" required class="w-full px-4 py-3 bg-gray-50 border-2 border-gray-300 rounded-lg text-sm font-bold">
                ...
                <?php $__currentLoopData = $inventoryItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($item->id); ?>"><?php echo e($item->part_name); ?> (<?php echo e($item->quantity); ?>)</option>
              ...
              <tbody class="divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $booking->parts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  <tr>
                    ...
                    <td class="px-4 py-3 text-center text-gray-600"><?php echo e($part->pivot->quantity); ?></td>
                    <td class="px-4 py-3 text-right text-gray-600">Rs. <?php echo e(number_format($part->pivot->unit_price, 2)); ?></td>
