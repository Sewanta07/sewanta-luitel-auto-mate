        ...
        <main class="ap-login-panel">
            <div class="ap-auth-container">
                ...
                <p class="ap-auth-subtitle">
                    Or <a href="<?php echo e(route('register')); ?>" class="ap-link">create a new account</a>
                </p>

                <form method="POST" action="<?php echo e(route('login')); ?>" class="ap-form">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="ap-form-meta">
                        <label for="remember" class="ap-checkbox-row">
                            <input id="remember" name="remember" type="checkbox" class="ap-checkbox" <?php echo e(old('remember') ? 'checked' : ''); ?>>
                            <span>Remember me</span>
                        </label>

                        <a href="<?php echo e(route('password.request')); ?>" class="ap-link ap-link-sm">Forgot your password?</a>
                    </div>
...
<?php echo $__env->make('layouts.public-core', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AutoMate\resources\views/auth/login.blade.php ENDPATH**/ ?>