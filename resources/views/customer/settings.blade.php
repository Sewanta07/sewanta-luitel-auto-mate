        ...
        <div class="container">
            ...
            <div class="dashboard-grid">
                <div class="dashboard-card">
                    ...
                    <a href="{{ route('customer.profile') }}" class="btn btn-primary btn-sm">Go to Profile</a>
                </div>
                ...
                <div class="dashboard-card">
                    ...
                    <a href="{{ route('customer.profile') }}#password-form" class="btn btn-primary btn-sm">Change Password</a>
                </div>
            </div>
        </div>
    </div>
