...
@section('title', 'Request a Service - AutoMate')
    ...
    <main class="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
            ...
            <form action="#" method="POST" class="p-6 sm:p-8 space-y-8">
                ...
                <section>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
                        ...
                        <div class="pb-1">
                            <a href="{{ route('customer.vehicles') }}" class="inline-flex items-center text-sm font-medium text-[#ff5a1f] hover:text-[#e64b15] transition">
                ...
                <section>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="date" id="preferred_date" name="preferred_date" required min="{{ date('Y-m-d') }}" class="block w-full px-4 py-3 rounded-xl border-gray-200 focus:border-[#ff5a1f] focus:ring-[#ff5a1f] transition duration-200">
                        </div>
                        <div class="space-y-2">
                ...
                <section class="bg-gray-50 p-6 rounded-2xl border border-dashed border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p class="text-gray-900 font-medium">{{ auth()->user()->name ?? 'Alex Rider' }}</p>
                        </div>
                        <div>
                            <label class="text-xs font-medium text-gray-400 block mb-1">Phone Number</label>
                            <p class="text-gray-900 font-medium">{{ auth()->user()->phone ?? '+977 9800000000' }}</p>
                        </div>
                    </div>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-end space-y-3 sm:space-y-0 sm:space-x-4 pt-4">
                    <a href="{{ route('dashboard.customer') }}" class="w-full sm:w-auto px-6 py-3 rounded-xl border border-gray-200 text-gray-700 font-semibold hover:bg-gray-50 transition text-center">
                        Cancel
                    </a>
        ...
        <div id="success-mockup" class="hidden mt-8 p-6 bg-green-50 border border-green-100 rounded-2xl flex items-start space-x-4 animate-bounce-in">
            ...
            <div>
                ...
                <p class="text-green-700 mt-1">Your service request has been received. You can track your request status from <a href="{{ route('customer.requests.index') }}" class="font-semibold underline">My Requests</a>.</p>
            </div>
        </div>
    </main>
</div>
