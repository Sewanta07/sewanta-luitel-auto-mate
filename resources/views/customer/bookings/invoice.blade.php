    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 p-6 sm:p-7">
            ...
            <div class="cs-invoice-actions mt-6 flex gap-3">
                ...
                <a href="{{ route('bookings.invoice.download', $booking->id) }}" class="flex-1 px-6 py-3 bg-[#ff5a1f] text-white font-black rounded-xl hover:bg-[#e44d18] text-center">Download PDF</a>
            </div>
        </div>
    </div>
</div>
