        ...
        <main class="ad-inv-main">
            ...
            <div class="ad-inv-head">
                ...
                <div class="ad-inv-head-actions">
                    <a href="{{ route('admin.inventory.reports') }}" class="ad-inv-btn ad-inv-btn-outline">
                        <svg class="ad-inv-btn-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                        Reports
                    </a>
                    <a href="{{ route('admin.inventory.create') }}" class="ad-inv-btn ad-inv-btn-primary">
                ...
                <div class="ad-inv-stat-card">
                    <div class="ad-inv-stat-row">
                        <div>
                            ...
                            <p class="ad-inv-stat-value ad-inv-stat-value-default">{{ $stats['total'] }}</p>
                ...
                <div class="ad-inv-stat-card">
                    <div class="ad-inv-stat-row">
                        <div>
                            ...
                            <p class="ad-inv-stat-value ad-inv-stat-value-orange">{{ $stats['low_stock'] }}</p>
                ...
                <div class="ad-inv-stat-card">
                    <div class="ad-inv-stat-row">
                        <div>
                            ...
                            <p class="ad-inv-stat-value ad-inv-stat-value-red">{{ $stats['out_of_stock'] }}</p>
                    ...
                    <table class="ad-inv-table">
                        ...
                        <tbody>
                            @forelse($items as $item)
                                ...
                                <tr class="ad-inv-row">
                                    <td>
                                        <p class="ad-inv-part-name">{{ $item->part_name }}</p>
                                    </td>
                                    <td>
                                        <span class="ad-inv-badge ad-inv-badge-category">{{ $item->category }}</span>
                                    </td>
                                    <td>
                                        <div class="ad-inv-stock-wrap">
                                            <div class="ad-inv-stock-bar-bg">
                                                <div class="ad-inv-stock-bar-fill {{ $item->stock_status === 'out_of_stock' ? 'ad-inv-stock-fill-red' : ($item->stock_status === 'low_stock' ? 'ad-inv-stock-fill-orange' : 'ad-inv-stock-fill-green') }}" style="width: {{ $stockPercent }}%;"></div>
                                            </div>
                                            <span class="ad-inv-stock-text">{{ $item->quantity }}/{{ $item->minimum_stock }}</span>
                                        </div>
                                    </td>
                                    <td>
                                        <p class="ad-inv-price">Rs. {{ number_format($item->unit_price, 2) }}</p>
                                    </td>
                                    <td>
                                    ...
                                    <td class="ad-inv-align-right">
                                        <div class="ad-inv-actions-row">
                                            <a href="{{ route('admin.inventory.edit', $item->id) }}" class="ad-inv-action-btn ad-inv-action-btn-edit">
                                            ...
                                            <form action="{{ route('admin.inventory.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this item? This action cannot be undone.');">
                                                @csrf
                                                @method('DELETE')
