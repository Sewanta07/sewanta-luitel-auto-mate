...
<div class="ad-rpen-page">
    ...
    <div class="ad-rpen-back-wrap">
        <a href="{{ route('admin.rentals.dashboard') }}" class="ad-rpen-back-link">
    ...
    <div class="ad-rpen-grid">
        ...
        <div class="ad-rpen-card">
            ...
            <img src="{{ asset('storage/' . $vehicle->image_path) }}" alt="Vehicle" class="ad-rpen-image">
            @else
            ...
            <div class="ad-rpen-card-body">
                <h3 class="ad-rpen-card-title">{{ $vehicle->vehicle_name }}</h3>
                <p class="ad-rpen-card-subtitle">{{ $vehicle->brand }} {{ $vehicle->model }} ({{ $vehicle->year }})</p>
                
                <div class="ad-rpen-details">
                    <div class="ad-rpen-detail-row">
                        <span class="ad-rpen-detail-label">Owner:</span>
                        <span class="ad-rpen-detail-value">{{ $vehicle->customer->name }}</span>
                    </div>
                    <div class="ad-rpen-detail-row">
                        <span class="ad-rpen-detail-label">Type:</span>
                        <span class="ad-rpen-detail-value">{{ $vehicle->vehicle_type }}</span>
                    </div>
                    <div class="ad-rpen-detail-row">
                        <span class="ad-rpen-detail-label">Daily Rate:</span>
                        <span class="ad-rpen-detail-value ad-rpen-detail-value-blue">Rs. {{ number_format($vehicle->daily_rate, 2) }}</span>
                    </div>
                    <div class="ad-rpen-detail-row">
                        <span class="ad-rpen-detail-label">Plate Number:</span>
                        <span class="ad-rpen-detail-value">{{ $vehicle->plate_number }}</span>
                    </div>
                    <div class="ad-rpen-detail-row">
                        <span class="ad-rpen-detail-label">Submitted:</span>
                        <span class="ad-rpen-submitted">{{ $vehicle->created_at->diffForHumans() }}</span>
                    </div>
                </div>

                <div class="ad-rpen-actions-row">
                    <form action="{{ route('admin.rentals.pending-listings.approve', $vehicle) }}" method="POST" class="ad-rpen-form-grow">
                        @csrf
