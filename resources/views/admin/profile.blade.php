    ...
    <div class="dashboard-content admin-layout">
        <aside class="admin-sidebar">
            <div class="sidebar-section">
                ...
                <a href="{{ route('admin.profile') }}" class="sidebar-link active">Profile</a>
        ...
        <main class="admin-main">
            <div class="container">
                    ...
                    <form method="POST" action="{{ route('admin.profile.update') }}" enctype="multipart/form-data" class="profile-form">
                            ...
                            <div class="profile-image-section">
                                <div class="profile-image-preview">
                                    @if($admin->profile_image)
                                        <img src="{{ asset('storage/' . $admin->profile_image) }}" alt="Profile Image" id="profile-preview">
                                    @else
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name', $admin->name) }}" required class="form-control @error('name') is-invalid @enderror">
                                @error('name')
                                    <span class="error-message">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" id="email" name="email" value="{{ old('email', $admin->email) }}" required class="form-control @error('email') is-invalid @enderror">
                                @error('email')
                                    <span class="error-message">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="tel" id="phone" name="phone" value="{{ old('phone', $admin->phone) }}" class="form-control @error('phone') is-invalid @enderror" placeholder="e.g., +1234567890">
                                @error('phone')
                                    <span class="error-message">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ ucfirst($admin->status) }}" class="form-control" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="current_address" name="current_address" rows="3" class="form-control @error('current_address') is-invalid @enderror" placeholder="Enter your full address">{{ old('current_address', $admin->current_address) }}</textarea>
                ...
                <div class="dashboard-section">
                    ...
                    <form method="POST" action="{{ route('admin.profile.password') }}" class="password-form">
                        @csrf
                ...
                <div class="dashboard-section">
                    ...
                    <div class="credentials-info">
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-value">{{ $admin->updated_at->format('F d, Y h:i A') }}</span>
                        </div>
                        @if($admin->email_verified_at)
                        <div class="info-row">
                            <span class="info-label">Email Verified:</span>
                            <span class="info-value badge success">{{ $admin->email_verified_at->format('F d, Y') }}</span>
                        </div>
                        @endif
                    </div>
                </div>
