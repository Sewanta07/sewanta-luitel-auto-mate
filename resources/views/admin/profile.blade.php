        ...
        <div class="ad-prof-grid">
                        ...
                        <div class="ad-prof-avatar-wrap">
                            <div class="ad-prof-avatar-lg">
                                @if($admin->profile_image)
                                    <img src="{{ asset('storage/' . $admin->profile_image) }}" alt="Profile" class="ad-prof-avatar-image-cover">
                                @else
                                    <span class="ad-prof-avatar-initial-lg">{{ strtoupper(substr($admin->name, 0, 1)) }}</span>
                                @endif
                            </div>
                        </div>
                        <h2 class="ad-prof-name">{{ $admin->name }}</h2>
                        <p class="ad-prof-email">{{ $admin->email }}</p>
                    ...
                    <div class="ad-prof-card-foot">
                        ...
                        <div class="ad-prof-details-list">
                            <div class="ad-prof-detail-row">
                                ...
                                <span class="ad-prof-mono">#{{ $admin->id }}</span>
                            </div>
                            <div class="ad-prof-detail-row">
                            ...
                            <div class="ad-prof-detail-row">
                                ...
                                <span class="ad-prof-detail-value">{{ $admin->created_at->format('M d, Y') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="ad-prof-right-col">
                ...
                <div class="ad-prof-card ad-prof-card-padded-lg">
                    ...
                    <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data" class="ad-prof-form-stack">
                        @csrf
                        ...
                        <div class="ad-prof-field">
                            ...
                            <div class="ad-prof-photo-row">
                                <div class="ad-prof-avatar-sm">
                                    @if($admin->profile_image)
                                        <img src="{{ asset('storage/' . $admin->profile_image) }}" alt="Profile" class="ad-prof-avatar-image-sm" id="profile-preview">
                                    @else
                                        <span class="ad-prof-avatar-initial-sm">{{ strtoupper(substr($admin->name, 0, 1)) }}</span>
                                    @endif
                                </div>
                                <div>
