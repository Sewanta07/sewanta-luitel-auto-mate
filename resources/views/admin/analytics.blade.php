            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-gray-800 mt-2">{{ number_format((int) ($servicesCompleted ?? 0)) }}</h3>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-gray-800 mt-2">
                            {{ $customerSatisfaction !== null ? number_format((float) $customerSatisfaction, 1) . '★' : 'N/A' }}
                        </h3>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-gray-800 mt-2">{{ number_format((int) ($activeCustomers ?? 0)) }}</h3>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="h-64 bg-gray-50 rounded-2xl flex items-center justify-center text-gray-400 border border-dashed border-gray-200"
                     ...
                     data-series='@json($monthlyRevenue ?? [])'>
                    [Chart Placeholder]
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="h-64 bg-gray-50 rounded-2xl flex items-center justify-center text-gray-400 border border-dashed border-gray-200"
                     ...
                     data-series='@json($serviceStatusCounts ?? [])'>
                    [Chart Placeholder]
                </div>
            </div>
        </div>
