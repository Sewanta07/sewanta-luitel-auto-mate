    ...
    <main class="max-w-7xl mx-auto p-6 grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <section class="lg:col-span-3 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                    @component('customer.components.quick-action-card', ['title' => 'Rent a Car', 'subtitle' => 'Browse and book available vehicles', 'bgColor' => '#f0fdf4', 'textColor' => '#10b981'])
                ...
                <div>
                    @component('customer.components.quick-action-card', ['title' => 'Payments', 'subtitle' => 'Pay for your service requests securely', 'bgColor' => '#eff6ff', 'textColor' => '#2563eb'])
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/></svg>
                    @endcomponent
                </div>

                <div>
                    @component('customer.components.quick-action-card', ['title' => 'View My Requests', 'subtitle' => 'Check status of existing requests', 'bgColor' => '#f5f3ff', 'textColor' => '#7c3aed'])
                ...
                <div>
                    @component('customer.components.quick-action-card', ['title' => 'Manage My Vehicles', 'subtitle' => 'Add or edit your vehicles', 'bgColor' => '#ecfeff', 'textColor' => '#0891b2'])
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0"></path></svg>
                    @endcomponent
                </div>

                <div>
                    @component('customer.components.quick-action-card', ['title' => 'Service History', 'subtitle' => 'View previous services and payments', 'bgColor' => '#fff1f2', 'textColor' => '#e11d48'])
        ...
        <aside class="space-y-4">
            ...
            <div class="p-6 rounded-2xl bg-gradient-to-br from-[#ff5a1f] to-[#e44d18] shadow-xl text-white">
                ...
                <div class="space-y-4">
                    <a href="{{ route('customer.payments') }}" class="flex items-center p-4 bg-white hover:bg-orange-50 rounded-2xl transition-all duration-300 group shadow-sm">
                    ...
                    <a href="{{ route('customer.rentals') }}" class="flex items-center p-4 bg-white hover:bg-orange-50 rounded-2xl transition-all duration-300 group shadow-sm">
                        <div class="w-12 h-12 bg-orange-100 rounded-xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform">
                    ...
                    <a href="{{ route('customer.payment-history') }}" class="flex items-center p-4 bg-white hover:bg-orange-50 rounded-2xl transition-all duration-300 group shadow-sm">
                        <div class="w-12 h-12 bg-orange-100 rounded-xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform">
