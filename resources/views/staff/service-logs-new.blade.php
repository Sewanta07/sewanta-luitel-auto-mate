                        ...
                        @forelse($logs as $log)
                            <tr class="hover:bg-gray-50 transition-colors group">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    @if($log->notes)
                                        <div class="text-xs text-gray-500 mt-1 line-clamp-2">{{ Str::limit($log->notes, 60) }}</div>
                                    @endif
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm font-bold text-gray-900">Rs. {{ number_format($log->booking->estimated_cost ?? 0, 2) }}</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <a href="{{ route('staff.bookings.show', $log->booking->id) }}" class="inline-flex items-center gap-1 px-3 py-2 rounded-lg bg-orange-50 text-orange-600 hover:bg-orange-100 transition font-bold text-sm">
