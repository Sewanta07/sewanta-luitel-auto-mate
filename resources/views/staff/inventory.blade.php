      ...
      <div class="sf-inv-stat-card">
        <div class="sf-inv-stat-row">
          <div>
            ...
            <p class="sf-inv-stat-value">{{ $stats['total'] }}</p>
          </div>
      ...
      <div class="sf-inv-stat-card">
        <div class="sf-inv-stat-row">
          <div>
            ...
            <p class="sf-inv-stat-value sf-inv-stat-value-orange">{{ $stats['low_stock'] }}</p>
          </div>
      ...
      <div class="sf-inv-stat-card">
        <div class="sf-inv-stat-row">
          <div>
            ...
            <p class="sf-inv-stat-value sf-inv-stat-value-red">{{ $stats['out_of_stock'] }}</p>
          </div>
        ...
        <table class="sf-inv-table">
          ...
          <tbody class="sf-inv-tbody">
            @forelse($items as $item)
              ...
              <tr class="sf-inv-row">
                <td class="sf-inv-td">
                  <p class="sf-inv-part-name">{{ $item->part_name }}</p>
                </td>
                <td class="sf-inv-td">
                  <span class="sf-inv-category-chip">{{ $item->category }}</span>
                </td>
                <td class="sf-inv-td">
                  <div class="sf-inv-stock-row">
                    <div class="sf-inv-stock-track">
                      <div class="sf-inv-stock-fill {{ $item->stock_status === 'out_of_stock' ? 'sf-inv-stock-fill-red' : ($item->stock_status === 'low_stock' ? 'sf-inv-stock-fill-orange' : 'sf-inv-stock-fill-green') }}" style="width: {{ max(0, min($stockPercent, 100)) }}%;"></div>
                    </div>
                    <span class="sf-inv-stock-count">{{ $item->quantity }}/{{ $item->minimum_stock }}</span>
                  </div>
                </td>
                <td class="sf-inv-td">
                  <p class="sf-inv-price">Rs. {{ number_format($item->unit_price, 2) }}</p>
                </td>
                <td class="sf-inv-td">
