            ...
            <form method="POST" action="{{ route('password.update') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-2 relative rounded-md shadow-sm">
                        <input 
                            ...
                            required 
                            class="block w-full px-4 py-3 pr-12 rounded-xl border @error('password') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-300 focus:ring-[#ff5a1f] focus:border-[#ff5a1f] @enderror sm:text-sm shadow-sm placeholder-gray-400"
                            placeholder="••••••••"
                        >
                        <button 
                            type="button" 
                ...
                <div>
                    ...
                    <div class="mt-2 relative rounded-md shadow-sm">
                        <input 
                            ...
                            autocomplete="new-password" 
                            required 
                            class="block w-full px-4 py-3 pr-12 rounded-xl border @error('password_confirmation') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-300 focus:ring-[#ff5a1f] focus:border-[#ff5a1f] @enderror sm:text-sm shadow-sm placeholder-gray-400"
                            placeholder="••••••••"
                        >
                        <button 
                            type="button" 
                ...
                <div class="text-center">
                    <p class="text-sm text-gray-600">
                        <a href="{{ route('login') }}" class="font-medium text-[#ff5a1f] hover:text-[#e64b15]">Back to Login</a>
                    </p>
                </div>
            </form>
