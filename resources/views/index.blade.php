        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    @auth
                        <a href="{{ route('dashboard.' . auth()->user()->role) }}" class="px-5 py-2.5 rounded-xl bg-[#ff5a1f] text-white text-sm font-bold hover:bg-[#e64b15] transition shadow-lg shadow-orange-200">
                            Dashboard
                        </a>
                    @else
                        <div class="flex items-center space-x-4">
                            <a href="{{ route('login') }}" class="text-sm font-bold text-gray-700 hover:text-gray-900">Log in</a>
                            <a href="{{ route('register') }}" class="px-5 py-2.5 rounded-xl bg-[#ff5a1f] text-white text-sm font-bold hover:bg-[#e64b15] transition shadow-lg shadow-orange-200">
                                Get Started
                            </a>
                        </div>
                    @endauth
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="lg:w-1/2">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    @auth
                        <a href="{{ route('dashboard.' . auth()->user()->role) }}" class="inline-flex justify-center items-center px-8 py-4 border border-transparent text-base font-bold rounded-2xl text-white bg-[#ff5a1f] hover:bg-[#e64b15] shadow-xl shadow-orange-200 transition transform hover:-translate-y-1">
                            Go to Dashboard
                    ...
                    @else
                        <a href="{{ route('register') }}" class="inline-flex justify-center items-center px-8 py-4 border border-transparent text-base font-bold rounded-2xl text-white bg-[#ff5a1f] hover:bg-[#e64b15] shadow-xl shadow-orange-200 transition transform hover:-translate-y-1">
                            Book a Service
                            <svg class="ml-2 -mr-1 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path></svg>
                        </a>
                        <a href="{{ route('login') }}" class="inline-flex justify-center items-center px-8 py-4 border border-gray-200 text-base font-bold rounded-2xl text-gray-700 bg-white hover:bg-gray-50 transition">
                            Log In
                        </a>
                    @endauth
                </div>
    ...
    <section id="services" class="py-24 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-end mb-16">
                ...
                <a href="{{ route('register') }}" class="hidden md:inline-flex items-center font-bold text-[#ff5a1f] hover:text-[#e64b15] transition">
                ...
                <div class="bg-gray-50 rounded-3xl p-8 lg:p-12">
                    ...
                    <form action="{{ route('contact.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') }}" required class="block w-full px-4 py-3 rounded-xl border-gray-200 focus:border-[#ff5a1f] focus:ring-[#ff5a1f] text-sm transition @error('name') border-red-300 @enderror">
                            @error('name')
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}" required class="block w-full px-4 py-3 rounded-xl border-gray-200 focus:border-[#ff5a1f] focus:ring-[#ff5a1f] text-sm transition @error('email') border-red-300 @enderror">
                            @error('email')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="subject" name="subject" value="{{ old('subject') }}" required class="block w-full px-4 py-3 rounded-xl border-gray-200 focus:border-[#ff5a1f] focus:ring-[#ff5a1f] text-sm transition @error('subject') border-red-300 @enderror">
                            @error('subject')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="message" name="message" rows="5" required class="block w-full px-4 py-3 rounded-xl border-gray-200 focus:border-[#ff5a1f] focus:ring-[#ff5a1f] text-sm transition resize-none @error('message') border-red-300 @enderror">{{ old('message') }}</textarea>
                            @error('message')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-gray-400">
                        ...
                        <li><a href="{{ route('login') }}" class="hover:text-[#ff5a1f] transition">Login</a></li>
                    </ul>
                </div>
                <div>
