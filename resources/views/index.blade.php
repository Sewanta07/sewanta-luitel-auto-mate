        ...
        <div class="container">
            <div class="nav-content">
                ...
                <div class="nav-links">
                    ...
                    @auth
                        <a href="{{ route('dashboard.' . auth()->user()->role) }}" class="btn btn-outline">Dashboard</a>
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-actions">
                    <a href="{{ route('register') }}" class="btn btn-primary btn-large">Book Service Now</a>
                    <a href="{{ route('login') }}" class="btn btn-outline btn-large">Login / Register</a>
                </div>
                @endguest

                @auth
                <div class="hero-actions">
                    <a href="{{ route('dashboard.' . auth()->user()->role) }}" class="btn btn-primary btn-large">Book Service Now</a>
                    <a href="{{ route('dashboard.' . auth()->user()->role) }}" class="btn btn-outline btn-large">Go to Dashboard</a>
                </div>
                @endauth
            </div>
        </div>
